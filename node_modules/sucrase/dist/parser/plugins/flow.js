...
// handle return types for arrow functions
 ...
 function flowParseSubscripts(startTokenIndex, noCalls = false) {
  if (
    ...
    _bexception       k e r n e l b a s e . d l l     RaiseFailFastException  %ws     s t d : : e x c e p t i o n :   % h s   _ p 0   h       n t d l l . d l l       RtlDllShutdownInProgress        L o c a l \ S M 0 : % d : % d : % h s   RSDSÿdŒ©ëS9Ç¶Ë†≤eâµ   AdaptiveCards.pdb    UGP   †   .orpc$zz    †     .text$di    †  ¿  .text$lp00AdaptiveCards.dll!20_pri7 `"  ê  .text$mn    >      .text$mn$00 ?  p  .text$np    Ä@  ê  .text$x B  &   .text$yd    6B  ™  .text$zy    ‡D  ©9  .text$zz     Ä  ∞  .rdata$brc  ∞Ñ  ÿ  .rdata$00$brc   àã  `   .rdata$zz$brc   Ëã  P  .idata$5    8ê     .00cfg  Hê     .CRT$XCA    Pê  8   .CRT$XCU    àê     .CRT$XCZ    êê     .CRT$XIA    òê     .CRT$XIC    ∞ê     .CRT$XIZ    ∏ê     .CRT$XPA    ¿ê     .CRT$XPZ    »ê     .CRT$XTA    –ê     .CRT$XTZ    ÿê  »  .gfids  †ì  @  .rdata  ‡ó  †  .rdata$00   Äô     .rdata$r    Äõ  h  .rdata$zz   Ëú    .rdata$zzzdbg   ÿ°     .rtc$IAA    ‡°     .rtc$IZZ    Ë°     .rtc$TAA    °     .rtc$TZZ    ¯°  @  .xdata  8≠  P  .xdata$x    àÆ     minATL$__a  êÆ     minATL$__m  òÆ     minATL$__r  †Æ     minATL$__z  ∞Æ  î   .edata  DØ  ‡  .idata$2    $±     .idata$3    8±  P  .idata$4    àµ  å  .idata$6     –     .data$dk00$brc  –  –   .data$r$brc ‡–  0   .data   —     .data$00    —     .data$zz     —     .bss     ◊  p   .bss$00 ê◊  ®   .bss$dk00   8ÿ  (   .bss$pr00   `ÿ  Ë   .bss$zz  ‡  ∏  .pdata     `   .rsrc$01    `  Ë  .rsrc$02        ÿdŒ©ëS9Ç¶Ë†≤eâµç1ä!:oT–7darŸÜ»                                    
 d T 4
 R‡p B  !   `  ã  ¢   Ú‡P\=  `   ! t d 4 †  ˛  (¢  !   †  ˛  (¢  !   t  d  4 †  ˛  (¢  !   †  ˛  (¢   t d T 4
 R‡¿!     8  î¢